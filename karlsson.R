...
#       Test how your model predict the testing dataset. Use 0.5 as separator 
#       Produce the accuracy rate
...
##According to the plot from line 69, the following three stats were the most 
# important in predicting Corsi-For% when playing with Karlsson (line 85). For context,
