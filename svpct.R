...
##I began collection on March 18, 2023.
...
columnY <- c("ID1", "ID2", "ID3", "ID4", "ID5", "ID6", "ID7",
...
barplot(height = playerfinal$columnx, main = "Percent of NHL Goalies drafted (by year) to play >= 1 league avg season; Y = year; ID1 = 2007", names=playerfinal$columnY, col="#69b3a2", horiz=T, las=1)
